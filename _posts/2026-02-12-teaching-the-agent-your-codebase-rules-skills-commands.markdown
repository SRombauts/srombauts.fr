...
This is part two of three. I am posting it the day of my first team sharing session,
*Using Cursor on our codebase: demo and sharing tips* (12 February 2026), because Skills
are what that demo is really about. In
[part one](/2026/01/26/why-out-of-the-box-ai-agents-fall-short/) I argued that an AI agent
...
## What I showed the VCS Tech team

For my own team, the Unity Version Control engineers, this ran as about forty minutes of
walkthrough and a short live demo. I went through the mental model from part one, the
onboarding stack of Rules, Skills, and Commands, and the Cursor features most people had not
tried yet: Plan mode, subagents, and the `@`-mentions that feed the agent exactly the
context it needs. Then I took a real Jira ticket from end to end, branch to drafted commit
message, with a self-review pass and checkpoints along the way. Skills drew the most
questions and were where I had put the most work, so the rest of this post goes deep on them.
...
Three kinds of docs do most of the work: Rules, Skills, and Commands.
